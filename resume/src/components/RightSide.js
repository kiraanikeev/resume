    ...
    return (
        <div className="RightSide">
            ...
            <h4 className='h4_title'>MESTO (React, version with authorization)</h4>
             ...
             <div className='div_project'><h5 className='heading'>technology:</h5>
             <p className='h5_title'>React(useState, useEffect, useContext, router), CSS(FLEX, GRID, Responsive design), localStorage</p>
             </div>
            ...
            <h3 className='h3_title'>Experience</h3>
             ...
             <div className='div_project'><h5 className='time'>March 2021 — december 2021</h5>
             <p className='h5_title'><strong>Yandex Practicum</strong></p></div>
             <div className='div_project'><h5 className='time'></h5>
             <p className='h5_title'><strong>Front-end developer (training)</strong></p></div>
             <div className='div_project'><h5 className='time'></h5>
             <p className='h5_title  NoStrong'>Training and development of websites using a different stack of technologies ( HTML, CSS, JavaScript, ReactJS)</p>
             </div>
             ...
             <p className='h5_title'><strong className='strong'>GE Money Bank</strong></p></div>
             <div className='div_project'><h5 className='time'></h5>
             <p className='h5_title'><strong>Underwriter</strong></p></div>
             <div className='div_project'><h5 className='time'></h5>
             <ul className='h5_title'><li className='li'>online review of customer profiles for granting a loan</li>
                                      <li className='li'>checking information about the borrower: analyzing personal data and provided documents, making phone calls</li>
                                      <li className='li'>making decisions about potential borrowers</li></ul>
             </div>

             <h3 className='h3_title'>Education</h3>

             <div className='div_project'><h5 className='time'>2013</h5>
             <p className='h5_title'><strong>Kazan Federal University</strong></p></div>
             <div className='div_project'><h5 className='time'></h5>
             <p className='h5_title'>Economic Department, Business Informatics, master of business informatics</p>
             </div>

             <div className='div_project'><h5 className='time'>2011</h5>
             <p className='h5_title'><strong>Kazan Federal University</strong></p></div>
             <div className='div_project'><h5 className='time'></h5>
             <p className='h5_title'>Economic Department, Business Informatics, bachelor of busines informatics</p>
             </div>
